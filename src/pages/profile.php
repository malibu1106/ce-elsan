...
<h1 class="text-blue-800 font-bold text-4xl text-center m-8">Mon profil</h1>
...
<button id="modify_mail_button" class="bg-gray-100 h-16 w-[80%] block mx-auto text-xl lg:text-2xl font-semibold text-blue-800">Modifier mon adresse mail</button>
...
<button id="modify_password_button" class="bg-gray-100 h-16 w-[80%] block mx-auto text-xl lg:text-2xl font-semibold text-blue-800 mt-8">Modifier mon mot de passe</button>
...
<form id="change_mail_form" class="flex flex-col p-4" action="../php_sql/edit_email.php" method="POST" style="display: none;">
    <input id="new_email" class="mb-6 h-16 text-2xl text-center text-blue-800" type="mail" placeholder="Nouvelle adresse mail" name="new_email" autocomplete="off" required>
    <div class="relative">
        <input id="password" class="mb-6 h-16 text-2xl text-center w-[100%] text-blue-800" type="password" placeholder="Mot de passe" name="password" required>
...
<form id="change_password_form" class="flex flex-col p-4" action="../php_sql/edit_password.php" method="POST" style="display: none;">
    <div class="relative mb-6">
        <input id="current_password" class="h-16 text-2xl text-center w-[100%] text-blue-800" type="password" placeholder="Mot de passe actuel" name="current_password" required>
        <span class="toggle-password absolute right-0 p-4" onclick="togglePassword('current_password', this)">
            <img class="show-hide-password w-8" src="../images/icons/show_password.png" alt="Afficher/Masquer mot de passe">
        </span> 
    </div>
    <div class="relative mb-6">
        <input id="new_password" class="h-16 text-2xl text-center w-[100%] text-blue-800" type="password" placeholder="Nouveau mot de passe" name="new_password" required>
        <span class="toggle-password absolute right-0 p-4" onclick="togglePassword('new_password', this)">
            <img class="show-hide-password w-8" src="../images/icons/show_password.png" alt="Afficher/Masquer mot de passe">
        </span> 
    </div>
    <div class="relative mb-6">
        <input id="confirm_new_password" class="h-16 text-2xl text-center w-[100%] text-blue-800" placeholder="Confirmer nouveau mot de passe" type="password" name="confirm_new_password" required>
