...
<body class="pb-8">
    ...
    <h1 class="text-blue-800 font-bold text-4xl text-center m-8">Gérer les suggestions</h1>
    <main class="p-1 flex flex-col gap-8 lg:flex-row lg:p-4 max-w-screen-2xl mx-auto">
        ...
        <section class="w-[96%] bg-yellow-500 mx-auto p-1 max-w-xl text-gray-100 pb-4">
            ...
            <form class="flex flex-col p-4" action="../php_sql/edit_suggestion.php" method="POST" enctype="multipart/form-data">
                ...
                <input class="mb-6 h-16 text-3xl text-center text-blue-800" type="text" placeholder="Nom de l'entreprise" name="company_name" value="<?php echo htmlspecialchars($suggestion_to_edit['company_name']); ?>" required>
                <textarea class="mb-6 h-48 text-3xl p-4 resize-none text-blue-800" id="description" name="description" placeholder="Description" required><?php echo htmlspecialchars($suggestion_to_edit['description']); ?></textarea>
    ...
    <?php endforeach; ?>
                ...
                <div class="container flex flex-col gap-4 justify-center items-center">
                    ...
                    <div class="mb-6 h-16 flex items-center justify-center">
                        <label class="bg-gray-100 text-blue-800 text-3xl p-4 cursor-pointer max-w-[250px] text-center truncate" for="image_url" <?php echo $suggestion_to_edit ? '' : 'required'; ?>>
                ...
                <input class="mb-6 h-16 text-3xl text-center text-blue-800" type="text" id="address" name="address" placeholder="Adresse" value="<?php echo htmlspecialchars($suggestion_to_edit['address']); ?>" required>
